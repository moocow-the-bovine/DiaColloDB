...
DiaColloDB::Logger - DiaColloDB logging facility using Log::Log4perl
...
=head1 SYNOPSIS
 ...
 $DiaColloDB::Logger::defaultLogOpts{$opt} = $val;
 $DiaColloDB::Logger::MIN_LEVEL = $min_log_level;
 
 ##========================================================================
 ## Functions: Initialization
 
 DiaColloDB::Logger->logInit(%opts);
 DiaColloDB::Logger->ensureLog(%opts);
 $DEFAULT_LOG_CONF = DiaColloDB::Logger->defaultLogConf(%opts)
...
DiaColloDB::Logger provides an abstract base class for
...
e.g. L<DiaColloDB::Logger::logInit()|/logInit>.
